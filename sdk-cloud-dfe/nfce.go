...
func (c nfce) Cria(payload map[string]interface{}) (interface{}, error) {
	resp, err := c.Base.Client.send(http.MethodPost, "/nfce", payload)

	return resp, err
}

func (c nfce) Preview(payload map[string]interface{}) (interface{}, error) {
	resp, err := c.Base.Client.send(http.MethodPost, "/nfce/preview", payload)

	return resp, err
}

func (c nfce) Status() (interface{}, error) {
	resp, err := c.Base.Client.send(http.MethodPost, "/nfce/status", nil)

	return resp, err
}

func (c nfce) Consulta(payload map[string]interface{}) (interface{}, error) {
...
func (c nfce) Busca(payload map[string]interface{}) (interface{}, error) {
	resp, err := c.Base.Client.send(http.MethodPost, "/nfce/busca", payload)

	return resp, err
}

func (c nfce) Cancela(payload map[string]interface{}) (interface{}, error) {
	resp, err := c.Base.Client.send(http.MethodPost, "/nfce/cancela", payload)

	return resp, err
}

func (c nfce) Offline() (interface{}, error) {
	resp, err := c.Base.Client.send(http.MethodGet, "/nfce/offline", nil)

	return resp, err
}

func (c nfce) Inutiliza(payload map[string]interface{}) (interface{}, error) {
	resp, err := c.Base.Client.send(http.MethodPost, "/nfce/inutiliza", payload)

	return resp, err
}

func (c nfce) Pdf(payload map[string]interface{}) (interface{}, error) {
	key, err := checkKey(payload)
	if err != nil {
		return nil, err
	}
...
func (c nfce) Substitui(payload map[string]interface{}) (interface{}, error) {
	resp, err := c.Base.Client.send(http.MethodPost, "/nfce/substitui", payload)

	return resp, err
}

func (c nfce) Backup(payload map[string]interface{}) (interface{}, error) {
	resp, err := c.Base.Client.send(http.MethodPost, "/nfce/backup", payload)

	return resp, err
}

func (c nfce) Importa(payload map[string]interface{}) (interface{}, error) {
